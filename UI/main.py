...
class MainWindow(QMainWindow):
    ...
    def show_help_info(self):
        QMessageBox.information(
            ...
            "• Автоматически отслеживает указанную область экрана или принимает номер из браузерного расширения\n"
            "• Распознаёт номер (или другой текст) с помощью Tesseract OCR\n"
            "• Отправляет найденный текст на выбранный принтер\n\n"
            "В комплекте имеется расширение `send_number_goods`, позволяющее передавать номера напрямую на локальный принт\u2011сервер.\n"
            "Интерфейс поддерживает светлую и тёмную тему.\n\n"
